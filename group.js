function runBar() {
  ...
  function runKitchen() {
    ...
    let employeeNameList = document.getElementById(`employeeNames_${kitchen_or_bar}`).value;

    
    dataForInkplate.employee = employeeNameList;
    dataForInkplate.matrix = MATRIX_DATA[kitchen_or_bar].join("");
    ...
    setTimeout(() => {
      sendTextToTelegram({
        ...
        parse_mode: "HTML",
        disable_notification: true,
        message: JSON.stringify(dataForInkplate)
      });
    }, 1000, false);
    //return;
